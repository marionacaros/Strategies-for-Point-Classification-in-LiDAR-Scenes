...
class TransformationNet(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, device, h_dim=1024):
        ...
        self.conv_3 = nn.Conv1d(128, h_dim, 1, bias=False)

        self.bn_1 = nn.BatchNorm1d(64)
        self.bn_2 = nn.BatchNorm1d(128)
        self.bn_3 = nn.BatchNorm1d(h_dim)
        self.bn_4 = nn.BatchNorm1d(512)
        self.bn_5 = nn.BatchNorm1d(256)

        self.fc_1 = nn.Linear(h_dim, 512)
    ...
    def forward(self, x):
        ...
        x = F.relu(self.bn_3(self.conv_3(x)))  # [batch, 1024, 4096]
...
class BasePointNet(nn.Module):
    ...
    def forward(self, x):
        num_points = x.shape[1]  # torch.Size([BATCH, N_SAMPLES, DIMS])
